...
<head>
    ...
    <style>
        .gold-gradient-bg { background: linear-gradient(135deg, #d9b977 0%, #C5A059 50%, #ae8541 100%); }
        .green-gradient-bg { background: linear-gradient(135deg, #144c25 0%, #0B2F17 50%, #072210 100%); }
    </style>
</head>
...
<header class="bg-brandGreen text-white sticky top-0 z-50 shadow-lg border-b border-brandGreen-dark">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-20">
            ...
            <nav class="hidden md:flex space-x-1 lg:space-x-4 items-center">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute left-0 mt-0 w-72 bg-white rounded-md shadow-xl py-2 invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-200 border border-slate-100 z-[60]">
                        ...
                        <a href="${relativePath}products/index.html" class="block px-4 py-2 text-xs font-bold text-brandGreen border-t border-slate-50 mt-1 hover:bg-brandIvory">All Products</a>
                    </div>
                </div>
                ...
                <div class="relative group">
                    ...
                    <div class="absolute left-0 mt-0 w-72 bg-white rounded-md shadow-xl py-2 invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-200 border border-slate-100 z-[60]">
                        <a href="${relativePath}applications/beauty-perfume-personal-care-packaging.html" class="block px-4 py-2 text-xs font-bold text-brandGreen hover:bg-brandIvory hover:text-brandGold">Beauty & Personal Care</a>
                        <a href="${relativePath}applications/chocolate-and-food-packaging.html" class="block px-4 py-2 text-xs font-bold text-brandGreen hover:bg-brandIvory hover:text-brandGold">Chocolate & Truffle Packaging</a>
                        <a href="${relativePath}applications/cake-boxes.html" class="block px-4 py-2 text-xs font-bold text-brandGreen hover:bg-brandIvory hover:text-brandGold">Cake & Bakery Packaging</a>
                        <a href="${relativePath}applications/date-dessert-boxes.html" class="block px-4 py-2 text-xs font-bold text-brandGreen hover:bg-brandIvory hover:text-brandGold">Date & Arabic Sweet Packaging</a>
                        <a href="${relativePath}applications/mooncake-boxes.html" class="block px-4 py-2 text-xs font-bold text-brandGreen hover:bg-brandIvory hover:text-brandGold">Mooncake & Festive Packaging</a>
                        <a href="${relativePath}applications/wine-liquor-packaging.html" class="block px-4 py-2 text-xs font-bold text-brandGreen hover:bg-brandIvory hover:text-brandGold">Wine & Liquor Packaging</a>
                        <a href="${relativePath}applications/jewelry-and-accessories-packaging.html" class="block px-4 py-2 text-xs font-bold text-brandGreen hover:bg-brandIvory hover:text-brandGold">Jewelry & Accessories</a>
                        <a href="${relativePath}applications/corporate-and-retail-packaging.html" class="block px-4 py-2 text-xs font-bold text-brandGreen hover:bg-brandIvory hover:text-brandGold">Corporate & Retail</a>
                ...
                <div class="relative group">
                    ...
                    <div class="absolute left-0 mt-0 w-64 bg-white rounded-md shadow-xl py-2 invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-200 border border-slate-100 z-[60]">
                        ...
                        <a href="${relativePath}holiday-occasions/baby-and-family-keepsake-packaging.html" class="block px-4 py-2 text-xs font-bold text-brandGreen hover:bg-brandIvory hover:text-brandGold">Baby & Family Keepsake</a>
                        ...
                        <a href="${relativePath}holiday-occasions/mothers-day-fathers-day-packaging.html" class="block px-4 py-2 text-xs font-bold text-brandGreen hover:bg-brandIvory hover:text-brandGold">Corporate Holiday Gifts</a>
            ...
            <div class="flex md:hidden">
                <button id="mobile-menu-btn" type="button" class="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-brandGold focus:outline-none">
    ...
    <div class="hidden md:hidden bg-brandGreen-dark border-t border-brandGreen" id="mobile-menu">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 text-sm">
            ...
            <a href="${relativePath}products/rigid-boxes.html" class="block text-sm font-medium pl-6 py-1 text-slate-300 hover:text-brandGold">Rigid Gift Boxes</a>
...
<footer class="bg-brandGreen-dark text-white border-t border-brandGold-dark pt-16 pb-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
            <h4 class="text-lg font-serif font-semibold text-brandGold mb-4">Core Products</h4>
            <ul class="space-y-2.5 text-sm text-slate-300">
                ...
                <li><a href="${relativePath}products/religious-gift-packaging.html" class="hover:text-brandGold transition-colors">Religious Packaging</a></li>
                <li><a href="${relativePath}products/index.html" class="hover:text-brandGold transition-colors">All Collections</a></li>
            </ul>
        </div>
        ...
        <div>
            ...
            <ul class="space-y-2.5 text-sm text-slate-300">
                <li><a href="${relativePath}applications/beauty-perfume-personal-care-packaging.html" class="hover:text-brandGold transition-colors">Beauty & Perfume</a></li>
                ...
                <li><a href="${relativePath}applications/wine-liquor-packaging.html" class="hover:text-brandGold transition-colors">Wine & Liquor</a></li>
        ...
        <div>
            ...
            <p class="text-sm text-slate-300 mb-1">📧 Email: info@slpack.net</p>
            <p class="text-sm text-slate-300 mb-1">📞 WhatsApp: +86 18818840878</p>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 pt-8 border-t border-brandGreen-light flex flex-col sm:flex-row items-center justify-between text-xs text-slate-400">
        <p>&copy; 2026 Guangzhou Shinelee Paper Product Co., Ltd. All rights reserved.</p>
...
<a href="https://wa.me/8618818840878?text=Hi%20Lisa,%20I'm%20interested%20in%20customizing%20packaging." target="_blank" class="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white p-3 rounded-full shadow-2xl hover:scale-110 transition-all flex items-center group">
