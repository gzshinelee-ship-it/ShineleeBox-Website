    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div class="md:col-span-1">
            ...
            <div class="mb-8 p-4 bg-brandGreen rounded-lg border border-brandGold/20 shadow-sm">
                <h5 class="text-brandGold text-[11px] font-bold uppercase tracking-widest mb-3 border-b border-brandGold/30 pb-1">Global Service Standard</h5>
                <ul class="space-y-2 text-[11px] text-slate-200">
                    <li class="flex items-start"><span class="text-brandGold mr-1.5">✓</span> <span><strong>USA DDP Logistics:</strong> Hassle-free door-to-door shipping including customs.</span></li>
                    <li class="flex items-start"><span class="text-brandGold mr-1.5">✓</span> <span><strong>Fast Sampling:</strong> 5-7 days rapid prototyping for 100% bespoke designs.</span></li>
                    <li class="flex items-start"><span class="text-brandGold mr-1.5">✓</span> <span><strong>Free Structural Support:</strong> Professional dieline design & engineering.</span></li>
                    <li class="flex items-start"><span class="text-brandGold mr-1.5">✓</span> <span><strong>ME Cultural Compliance:</strong> 18+ years in luxury Ramadan & Eid packaging.</span></li>
                </ul>
            </div>
