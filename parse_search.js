const fs = require('fs');
const content = fs.readFileSync('/Users/shengli/.accio/accounts/1734048962/agents/MID-72048962U1778208-42DE2D-2406-451DC5/agent-core/tool-results/CID-72048962U1780823-42DE2D-0628-CBB488_sub_browser_d05f3524/web_fetch_fcc1034a-b4e5-4470-98b7-1993db539838.txt', 'utf8');
...
for (let i = 1; i < pages.length; i++) {
    ...
    // Format is often: [Title](https://www.alibaba.com/product-detail/...)
    // and price/MOQ follows nearby.
    ...
    products.forEach((p, idx) => {
        // Let's grab some context around this match to find price and MOQ
        ...
        // Match prices (e.g. $1.77-3.54 or US$1.77 or similar) and MOQ
