...
const main = `<main class="flex-grow">
    ...
    <article>
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14 text-slate-700 leading-7">
            ...
            <p class="mt-5">The round green box in the reference image uses a radial arrangement to create a ceremonial reveal. Buyers looking for this presentation can review our <a href="../products/custom-half-moon-round-date-gift-box.html" class="font-semibold text-brandBurgundy underline decoration-brandGold underline-offset-4 hover:text-brandGold">CS-007 Custom Half-Moon Round Date Gift Box</a>, featuring a half-moon reveal and customizable radial compartments. This visual direction can work well, but a production-ready box cannot be designed from appearance alone. The date size, count, primary food-contact packaging, total filled weight, packing method and destination rules must all be defined first.</p>
            ...
            <section class="mt-12 bg-white border border-brandGold/40 p-6 sm:p-8 luxury-shadow" aria-labelledby="recommended-date-box">
                <div class="grid sm:grid-cols-[180px_1fr] gap-7 items-center">
                    <a href="../products/custom-half-moon-round-date-gift-box.html" class="block bg-brandIvory border border-brandBeige aspect-square overflow-hidden"><img src="../images/products/CS-007_half-moon-date-gift-box/main.jpg" alt="ShineleeBox CS-007 half-moon round date gift box" width="1200" height="1200" loading="lazy" decoding="async" class="w-full h-full object-cover"></a>
                    <div><p class="text-[10px] text-brandGold font-bold uppercase tracking-[0.2em]">Recommended Date Packaging · CS-007</p><h2 id="recommended-date-box" class="font-serif text-2xl font-bold text-brandCharcoal mt-2">Custom Half-Moon Round Date Gift Box</h2><p class="mt-3 text-sm text-slate-600 leading-relaxed">Explore this production-ready concept when your brief calls for a round rigid presentation box, half-moon reveal lid and radial compartments for premium dates, chocolates or dried-fruit assortments.</p><a href="../products/custom-half-moon-round-date-gift-box.html" class="inline-flex mt-5 bg-brandBurgundy text-white px-6 py-3 text-[10px] font-bold uppercase tracking-widest hover:opacity-90">View CS-007 Product Details →</a></div>
                </div>
            </section>
            ...
            <section class="mt-12 bg-brandIvory border border-brandBeige p-7">
                ...
                <ul class="mt-4 space-y-3 text-brandBurgundy font-semibold">
                    <li><a href="../products/custom-half-moon-round-date-gift-box.html" class="hover:text-brandGold">Half-Moon Round Date Gift Box — CS-007 →</a></li>
            ...
            <div class="bg-brandCharcoal text-white p-8 mt-12 border border-brandGold/40">
                ...
                <a href="../contact.html?product=CS-007" class="inline-block bg-brandBurgundy text-white font-bold px-8 py-3 hover:opacity-90 uppercase tracking-widest text-xs">Send Your Packaging Brief</a>
            </div>
        </div>
    </article>
</main>`;
