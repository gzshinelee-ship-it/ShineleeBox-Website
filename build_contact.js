...
function buildContactPage() {
    const title = "Get a Free Sample & Quote with a 2-Hour Reply | ShineleeBox";
    ...
    <section class="py-16 bg-brandIvory">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-500 leading-relaxed">Custom packaging orders start from 50 pieces.</p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <h4 class="font-serif font-bold text-brandGreen text-sm">Free Sample · 5–7 Days</h4>
                                <p class="text-xs text-slate-500 leading-relaxed">We provide free sampling, normally completed in 5–7 days after the structure and artwork are confirmed.</p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <h4 class="font-serif font-bold text-brandGreen text-sm">20–25 Day Production</h4>
                                <p class="text-xs text-slate-500 leading-relaxed">Standard mass-production lead time is approximately 20–25 days after final approval.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-8 bg-white p-8 rounded-lg border border-slate-100 shadow-md">
                    <div class="mb-8 border-b border-slate-100 pb-5 text-center sm:text-left">
                        ...
                        <p class="text-brandGold font-serif text-lg font-semibold mt-1">Receive a Reply Within 2 Hours</p>
                    </div>

                    <form id="inquiryForm" action="https://formspree.io/f/mwvjypbe" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="userName" name="name" required autocomplete="name" placeholder="John Smith"
                            ...
                            <div>
                                ...
                                <input type="text" id="companyName" name="company" autocomplete="organization" placeholder="Your Brand / Company"
                                       class="w-full px-4 py-3 rounded border border-slate-200 text-sm focus:outline-none focus:border-brandGold transition-all">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="email" id="userEmail" name="email" required autocomplete="email" placeholder="john@company.com"
                                       class="w-full px-4 py-3 rounded border border-slate-200 text-sm focus:outline-none focus:border-brandGold transition-all">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="tel" id="userPhone" name="phone" required autocomplete="tel" placeholder="+1 234 567 8900"
                                       class="w-full px-4 py-3 rounded border border-slate-200 text-sm focus:outline-none focus:border-brandGold transition-all">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="productType" name="product_type" required
                                    ...
                                    <option value="Lid and Base Rigid Box">Lid &amp; Base Rigid Box</option>
                                    <option value="Foldable Rigid Box">Foldable Rigid Box</option>
                                    <option value="Round or Cylinder Gift Box">Round / Cylinder Gift Box</option>
                                    <option value="Suitcase Gift Box">Suitcase Gift Box</option>
                                    <option value="Chocolate and Food Packaging">Chocolate / Food Packaging</option>
                                    <option value="Wine and Liquor Packaging">Wine / Liquor Packaging</option>
                                    <option value="Beauty and Perfume Packaging">Beauty / Perfume Packaging</option>
                                    <option value="Luxury Gift Set Collection">Luxury Gift Set Packaging</option>
                                    <option value="Other Custom Packaging">Other Custom Packaging</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select id="estimatedQuantity" name="estimated_quantity" required
                                        class="w-full px-4 py-3 rounded border border-slate-200 text-sm focus:outline-none focus:border-brandGold bg-white transition-all">
                        ...
                        <div>
                            ...
                            <textarea id="customRequirements" name="requirements" rows="4" placeholder="Box size, color, special finish, intended use... Any details help us quote faster."
                        ...
                        <div>
                            ...
                            <div class="border-2 border-dashed border-slate-200 rounded-lg p-6 text-center hover:border-brandGold transition-all cursor-pointer bg-slate-50 relative">
                                <input type="file" id="refFile" name="reference_file" accept=".png,.jpg,.jpeg,.pdf,.ai" class="absolute inset-0 opacity-0 cursor-pointer w-full h-full">
                        ...
                        <div>
                            ...
                            <span class="block text-[10px] text-slate-400 text-center mt-3">
                                🔒 Your information is safe. We respond within 2 hours.
                            </span>
                        </div>
                    </form>
                </div>
            ...
            <div class="mt-12 bg-white border border-slate-100 rounded-lg shadow-sm p-6 sm:p-8">
                <h2 class="font-serif text-2xl font-bold text-brandGreen">Confirmed Custom Packaging Terms</h2>
                <p class="mt-2 text-sm text-slate-500">Use these standard terms for early project planning. Final specifications are confirmed against your product, structure and destination.</p>
                <dl class="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 text-sm">
                    <div class="border-l-2 border-brandGold pl-4"><dt class="font-bold text-brandGreen">MOQ</dt><dd class="mt-1 text-slate-600">From 50 pieces</dd></div>
                    <div class="border-l-2 border-brandGold pl-4"><dt class="font-bold text-brandGreen">Sample</dt><dd class="mt-1 text-slate-600">Free sample · 5–7 days</dd></div>
                    <div class="border-l-2 border-brandGold pl-4"><dt class="font-bold text-brandGreen">Production</dt><dd class="mt-1 text-slate-600">Approximately 20–25 days</dd></div>
                    <div class="border-l-2 border-brandGold pl-4"><dt class="font-bold text-brandGreen">Response</dt><dd class="mt-1 text-slate-600">Within 2 hours</dd></div>
                    <div class="border-l-2 border-brandGold pl-4"><dt class="font-bold text-brandGreen">Custom sizing</dt><dd class="mt-1 text-slate-600">Designed around your product dimensions</dd></div>
                    <div class="border-l-2 border-brandGold pl-4"><dt class="font-bold text-brandGreen">Insert options</dt><dd class="mt-1 text-slate-600">Paper, PET blister, EPE foam or EVA</dd></div>
                    <div class="border-l-2 border-brandGold pl-4"><dt class="font-bold text-brandGreen">Food contact</dt><dd class="mt-1 text-slate-600">Food-grade paper options available</dd></div>
                    <div class="border-l-2 border-brandGold pl-4"><dt class="font-bold text-brandGreen">Sea shipping estimate</dt><dd class="mt-1 text-slate-600">USA 25–30 days · Europe 50 days · Middle East 50 days</dd></div>
                </dl>
            </div>
        </div>
    </section>
    ...
    <div id="successModal" class="fixed inset-0 bg-slate-900/60 backdrop-blur-xs hidden items-center justify-center z-50 p-4">
        <div class="bg-white rounded-lg p-8 max-w-md w-full shadow-2xl border border-slate-100 text-center space-y-4">
            ...
            <p class="text-xs text-slate-500 leading-relaxed">
                Thank you for your request. Lisa, our Sales Director, has received your packaging parameters and will respond within 2 hours.
            </p>
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', () => {
            ...
            const dielineParam = urlParams.get('dieline');

            const productTypeSelect = document.getElementById('productType');
            const customReqs = document.getElementById('customRequirements');

            if (dielineParam === 'true') {
                customReqs.value = "I am interested in your FREE 2026 Advent Calendar Dieline Service. Please contact me regarding the structural specifications and my product dimensions.";
                ...
                if (productParam.startsWith('IP-')) {
                    ...
                    productTypeSelect.value = "Advent Calendar Box";
                } else if (productParam.startsWith('RB-')) {
                    productTypeSelect.value = "Round or Cylinder Gift Box";
                } else if (productParam.startsWith('DR-')) {
                    productTypeSelect.value = "Drawer Sliding Gift Box";
                } else if (productParam.startsWith('MG-')) {
                    productTypeSelect.value = "Magnetic Rigid Gift Box";
                } else if (productParam.startsWith('SC-')) {
                    productTypeSelect.value = "Suitcase Gift Box";
                } else if (productParam.startsWith('CS-')) {
                    productTypeSelect.value = "Custom Shape Specialty Box";
                } else if (productParam.startsWith('CHOC-') || productParam.startsWith('CFP-')) {
                    productTypeSelect.value = "Chocolate and Food Packaging";
                }
        ...
        // Submit to Formspree for real email notifications
        document.getElementById('inquiryForm').addEventListener('submit', function(e) {
            ...
            fetch('https://formspree.io/f/mwvjypbe', {
                method: 'POST',
                body: formData,
                headers: {
                ...
                if (response.ok) {
                    ...
                    alert("Ops! There was a problem submitting your inquiry. Please email info@slpack.net directly.");
                }
            }).catch(error => {
